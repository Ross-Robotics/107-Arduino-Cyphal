...
#ifndef RR_DATA_TYPES_SENSORS_RANGE_ARRAY_1_0_HPP_INCLUDED
#define RR_DATA_TYPES_SENSORS_RANGE_ARRAY_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/home/joe/Data/mk4_firmware/libs/external/107-Arduino-Cyphal/rr_data_types/sensors/RangeArray.1.0.dsdl "
...
inline nunavut::support::SerializeResult serialize(const RangeArray_1_0& obj,
...
inline nunavut::support::SerializeResult deserialize(RangeArray_1_0& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    // saturated float32[5] range
    for (std::size_t _index4_ = 0U; _index4_ < 5UL; ++_index4_)
    {
        obj.range[_index4_] = in_buffer.getF32();
...
#endif // RR_DATA_TYPES_SENSORS_RANGE_ARRAY_1_0_HPP_INCLUDED
