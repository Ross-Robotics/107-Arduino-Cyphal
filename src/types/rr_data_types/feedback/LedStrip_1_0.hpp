...
// Source file:   /home/joe/Data/mk4_firmware/libs/external/107-Arduino-Cyphal/rr_data_types/feedback/LedStrip.1.0.dsdl
// Generated at:  2025-02-12 14:20:09.905704 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef RR_DATA_TYPES_FEEDBACK_LED_STRIP_1_0_HPP_INCLUDED
#define RR_DATA_TYPES_FEEDBACK_LED_STRIP_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/home/joe/Data/mk4_firmware/libs/external/107-Arduino-Cyphal/rr_data_types/feedback/LedStrip.1.0.dsdl "
...
struct LedStrip_1_0 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr std::size_t ExtentBytes                  = 59UL;
        static constexpr std::size_t SerializationBufferSizeBytes = 59UL;
        ...
        struct TypeOf
        {
            ...
            using strip_name = std::vector<std::uint8_t>;
    ...
    _traits_::TypeOf::strip_name strip_name{};

    _traits_::TypeOf::mode mode{};
};

inline nunavut::support::SerializeResult serialize(const LedStrip_1_0& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    const std::size_t capacity_bits = out_buffer.size();
    if ((static_cast<std::size_t>(capacity_bits)) < 472UL)
    {
    ...
    {   // saturated uint8[<=50] strip_name
        if (obj.strip_name.size() > 50)
        {
            return -nunavut::support::Error::SerializationBadArrayLength;
        }
        // Array length prefix: truncated uint8
        const auto _result3_ = out_buffer.setUxx(obj.strip_name.size(), 8U);
        if(not _result3_){
            return -_result3_.error();
        }
        out_buffer.add_offset(8U);
        for (std::size_t _index2_ = 0U; _index2_ < obj.strip_name.size(); ++_index2_)
        {
            // Saturation code not emitted -- native representation matches the serialized representation.
            const auto _result3_ = out_buffer.setUxx(obj.strip_name[_index2_], 8U);
            if(not _result3_){
                return -_result3_.error();
            }
            out_buffer.add_offset(8U);
    ...
    {   // saturated uint8 mode
        // Saturation code not emitted -- native representation matches the serialized representation.
        const auto _result3_ = out_buffer.setUxx(obj.mode, 8U);
        if(not _result3_){
            return -_result3_.error();
        }
        out_buffer.add_offset(8U);
...
inline nunavut::support::SerializeResult deserialize(LedStrip_1_0& obj,
...
#endif // RR_DATA_TYPES_FEEDBACK_LED_STRIP_1_0_HPP_INCLUDED
