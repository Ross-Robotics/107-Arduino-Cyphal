...
// Source file:   /home/joe/Data/mk4_firmware/libs/external/107-Arduino-Cyphal/rr_data_types/feedback/PtuPosition.1.0.dsdl
// Generated at:  2025-02-12 14:20:09.907235 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef RR_DATA_TYPES_FEEDBACK_PTU_POSITION_1_0_HPP_INCLUDED
#define RR_DATA_TYPES_FEEDBACK_PTU_POSITION_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/home/joe/Data/mk4_firmware/libs/external/107-Arduino-Cyphal/rr_data_types/feedback/PtuPosition.1.0.dsdl "
...
inline nunavut::support::SerializeResult serialize(const PtuPosition_1_0& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // saturated float32 pan
        ...
        auto _result4_ = out_buffer.setF32(obj.pan);
        if(not _result4_){
    ...
    {   // saturated float32 tilt
        // Saturation code not emitted -- assume the native representation of float32 is conformant.
        static_assert(NUNAVUT_PLATFORM_IEEE754_FLOAT, "Native IEEE754 binary32 required. TODO: relax constraint");
        auto _result4_ = out_buffer.setF32(obj.tilt);
        if(not _result4_){
            return -_result4_.error();
        }
        out_buffer.add_offset(32U);
...
inline nunavut::support::SerializeResult deserialize(PtuPosition_1_0& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    // saturated float32 pan
    obj.pan = in_buffer.getF32();
    in_buffer.add_offset(32U);
    // saturated float32 tilt
    obj.tilt = in_buffer.getF32();
    in_buffer.add_offset(32U);
...
#endif // RR_DATA_TYPES_FEEDBACK_PTU_POSITION_1_0_HPP_INCLUDED
